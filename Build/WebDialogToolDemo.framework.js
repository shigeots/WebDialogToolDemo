...
// Begin JS library code
  ...
  function _DisplayAlert(alertMessage) {
      window.alert(UTF8ToString(alertMessage));
    }

  function _DisplayConfirm(confirmMessage) {
      let resultValue = confirm(UTF8ToString(confirmMessage));
      return resultValue;
    }

  function _DisplayDialog(dialogId) {
  ...
  function _DisplayPrompt(promptMessage) {
...
var wasmImports = {
  ...
  /** @export */
  DisplayConfirm: _DisplayConfirm,
  /** @export */
